...
func _load_all_sounds():
	...
	sfx_streams["player_death"] = [load("res://Assets/Characters/Player/SFX_player_death.mp3")]
	...
	sfx_streams["bow_hold"] = [load("res://Assets/Characters/Player/MANTENER_ARCO.mp3")]

	sfx_streams["player_laugh"] = [load("res://Assets/Characters/Player/RISA_PERSONAJE.mp3")]
	...
	sfx_streams["goblin_laugh"] = [load("res://Assets/Characters/Goblin/RISA_GOBLING_3.mp3")]
	...
	sfx_streams["trident_shot"] = [load("res://Assets/Characters/Imp/TRIDENTE_SHOT.mp3")]
	...
	sfx_streams["shield_break"] = [load("res://Assets/Environment/Shield/ESCUDO_ROTO.mp3")]
