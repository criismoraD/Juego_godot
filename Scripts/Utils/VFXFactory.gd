...
static var particle_amount_multiplier: float = 1.0
...
static func spawn_impact(world: Node, position: Vector3, color: Color = Color.WHITE,
		amount: int = 15, size: float = 0.05) -> GPUParticles3D:
	if not vfx_enabled:
		return null
...
static func spawn_muzzle_flash(world: Node, position: Vector3, direction: Vector3,
		color: Color = Color(1.0, 0.7, 0.0)) -> GPUParticles3D: # Amarillo incandescente
	if not vfx_enabled:
		return null
...
static func spawn_blood(world: Node, position: Vector3, direction: Vector3 = Vector3.LEFT,
		color: Color = Color(0.8, 0.1, 0.1)) -> GPUParticles3D:
	if not vfx_enabled:
		return null
...
static func spawn_dust(world: Node, position: Vector3,
		color: Color = Color(0.6, 0.5, 0.4, 0.7)) -> GPUParticles3D:
	if not vfx_enabled:
		return null
...
static func spawn_jump(world: Node, position: Vector3,
		color: Color = Color(0.7, 0.65, 0.5, 0.5),
		scale_min: float = 0.05,
		scale_max: float = 0.15) -> GPUParticles3D:
	if not vfx_enabled:
		return null
...
static func spawn_death_explosion(world: Node, position: Vector3,
		color: Color = Color(1.0, 0.6, 0.2)) -> GPUParticles3D:
	if not vfx_enabled:
		return null
...
static func spawn_sparks(world: Node, position: Vector3, direction: Vector3 = Vector3.UP,
		color: Color = Color(1.0, 0.9, 0.5)) -> GPUParticles3D:
	if not vfx_enabled:
		return null
...
static func create_arrow_trail(arrow: Node3D, color: Color = Color(0.8, 0.9, 1.0, 0.5)) -> GPUParticles3D:
	if not vfx_enabled:
		return null
