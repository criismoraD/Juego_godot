...
# Física
@export var material_escudo: Material = preload("res://Entities/Ambiente_Escudo/MAT_shield.tres")
@export var material_interior: Material = preload("res://Entities/Ambiente_Escudo/ESCUDO_INT.tres")
