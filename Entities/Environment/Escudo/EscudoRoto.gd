...
# Física
@export var material_escudo: Material = preload("res://Entities/Environment/Escudo/MAT_shield.tres")
@export var material_interior: Material = preload("res://Entities/Environment/Escudo/ESCUDO_INT.tres")
