...
@export var municion_a_otorgar_jugador: int = 10  ## Otorga 10 flechas explosivas al jugador
...
const SONIDO_PICKUP: String = "res://Entities/Item_Pocion/Sonido posion.mp3"
