...
- Muro_Plataforma: Creada escena `Muro_Plataforma.tscn` en la carpeta `PLATAFORMA_MURO_NIVEL03` instanciando `MURO_PLATAFORMA.glb` e incorporando un `CollisionShape3D` de caja.
