...
const MARCA_ZONA_CAIDA_REF = preload("res://LONKO/Marca_Zona_Caida.gd")
const VFX_ELECTRICO_REF = preload("res://LONKO/Flecha_Electrica.tscn")
const SFX_RAYO_ULT_STREAM = preload("res://LONKO/Sonido rayo ult.mp3")
