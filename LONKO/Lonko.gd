...
const FLECHA_ELECTRICA_SCENE = preload("res://LONKO/Flecha_Electrica_Ataque.tscn")
...
var sfx_cargando_sp_stream: AudioStream = preload("res://LONKO/Cargando SP.mp3")
...
# Recursos de pilares
var pilar_destruido_scene: PackedScene = preload("res://LONKO/PILAR_DESTRUIDO.glb")
var explocion_pilar_scene: PackedScene = preload("res://LONKO/Explocion_Pilar.tscn")
var tex_pilar_destruido: Texture2D = preload("res://LONKO/PILAR_DESTRUIDO_D.jpg")
var tex_pilar_normal: Texture2D = preload("res://LONKO/PILAR_LONKO_D.jpg")
var sfx_explosion_01: AudioStream = preload("res://LONKO/EXPLOSION01.mp3")
var sfx_explosion_02: AudioStream = preload("res://LONKO/EXPLOSION02.mp3")
...
func _configurar_particulas_pisada() -> void:
	...
	var tex := load("res://LONKO/humo pisada.png") as Texture2D
	if tex:
...
func _crear_particulas_rocas_destruccion(spawn_pos: Vector3) -> void:
	...
	var tex := load("res://LONKO/PIEDRAS_NEGRAS_ DESTRUCION.png") as Texture2D
